...
def main():
    ...
    parser.add_argument("--load_model", default="") # Model load file name, "" doesn't load, "default" uses file_name TD3_AUTOENCODER_
    ...
    for cycle in range(args.cycles):
        ...
        if Fa;se: # shouldn't update the mean_std data during training
