...
def main():
    ...
    parser.add_argument("--load_model", default="TD3_AUTOENCODER_10") # Model load file name, "" doesn't load, "default" uses file_name TD3_AUTOENCODER_
    ...
    # 为每个进程创建独立的 Queue
    process_queues = [manager.Queue(max_size = args.data_collection_step) for _ in range(args.num_processes)]
    ...
    for cycle in range(args.cycles):
        ...
        if args.load_model == "":
            policy_flag = True if cycle > 1 else False
        else:
            policy_flag = True
