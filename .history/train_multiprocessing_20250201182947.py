...
def main():
    ...
    parser.add_argument("--seed", default=4090, type=int)              # Sets Gym, PyTorch and Numpy seeds
    ...
    parser.add_argument("--data_collection_step", default=48*1, type=int)   # how many steps to collect data each run 48*8 (8hours)
