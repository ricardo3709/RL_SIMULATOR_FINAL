...
def eval_policy(policy, env_name, seed, eval_episodes=1): #temp change to 1
	# eval_env = gym.make(env_name)
	eval_env = ManhattanTrafficEnv()
...
if __name__ == "__main__":
	...
	parser.add_argument("--mpi", action="store_true")               # Use MPI for parallel sampling
	...
	if args.policy == "TD3":
		...
		# gnn_encoder = TD3.GNN_Encoder(num_features=NUM_FEATURES, hidden_dim=128, output_dim=kwargs['state_dim'])
