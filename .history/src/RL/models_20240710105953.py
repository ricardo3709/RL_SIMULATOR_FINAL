...
class DDPG_Agent(nn.Module):
    def __init__(self, state_dim, action_dim, max_action):
        ...
        self.critic_optimizer = optim.Adam(list(self.critic.parameters()), lr=critic_learning_rate)
    ...
    def select_action(self, state):
        ...
        noise = torch.randn_like(action)*0.5
    ...
    def update_policy(self, last_reward, current_state, last_state):
        ...
        last_reward = last_reward.to(device)
        ...
        with torch.autograd.set_detect_anomaly(False):
            ...
            critic_loss.backward(retain_graph=Fa)
            ...
            actor_loss = -torch.mean(self.critic.forward(current_state.detach(), current_action.detach()))
