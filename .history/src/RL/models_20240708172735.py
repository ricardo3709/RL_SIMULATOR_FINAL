...
class DDPG_Agent(nn.Module):
    ...
    def select_action(self, state):
        ...
        with torch.no_grad():
            ...
            action, output = self.actor(state).cpu().data.numpy()
