...
def feature_preparation(state):
    ...
    [avaliable_veh_nodes, reba, gen_counts_areas, rej_counts_areas, attraction_counts_areas] = state
    [idle_veh_nodes, rebalancing_veh_nodes, current_working_veh_nodes, future_working_veh_nodes_in_5, future_working_veh_nodes_in_10, gen_counts_nodes, rej_counts_nodes]
