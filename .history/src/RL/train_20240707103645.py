    ...
    with open('training_log_1.txt', 'w') as log_file:
        for epoch in range(epochs):
            ...
            while not done:
                ...
                current_state_encoded = gnn_encoder(current_graph_data, current_past_rej)  # encode the state (1,32)
                last_state_encoded = gnn_encoder(last_graph_data, last_past_rej)  # encode the state (1,32)
