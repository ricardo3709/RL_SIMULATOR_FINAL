...
def feature_preparation(state):
    ...
    features_tensor = torch.stack(
        [avaliable_veh_areas, 
         ...
         future_working_veh_areas_in_5, future_working_veh_areas_in_10, request_gen_counts_areas_col, request_rej_counts_areas_col, request_attraction_counts_areas_col],
        dim=0
