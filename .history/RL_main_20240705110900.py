import torch
from RL.models_ori import GNN_Encoder, GNN_Encoder_seperate , DDPG_Agent
...
if __name__ == "__main__":
    ...
    # Initialize models
    gnn_encoder = GNN_Encoder(num_features=NUM_FEATURES*2, hidden_dim=128, output_dim=state_dim).to(device)
