...
from src.RL.TD3 import TD3, GNN_Encoder
...
if __name__ == "__main__":
    ...
    # Setup dimensions
    state_dim = 32  #output dimension from GNN
    ...
    TD3_agent = DDPG_Agent(state_dim=state_dim, action_dim=action_dim, max_action= max_action).to(device)
